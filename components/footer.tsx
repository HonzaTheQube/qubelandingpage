      ...
      <div className="container">
        <div className="flex flex-col items-center justify-center">
          <div className="flex justify-center space-x-10">
            <Link
              href="https://www.linkedin.com/company/102381684/admin/dashboard/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-light/70 hover:text-[#0077B5] transition-colors group"
            >
            ...
            <Link
              href="https://www.youtube.com/@honza_nedvidek"
              target="_blank"
              rel="noopener noreferrer"
              className="text-light/70 hover:text-[#FF0000] transition-colors group"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <Link
              href="https://www.instagram.com/qube_ai_/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-light/70 hover:text-[#E4405F] transition-colors group"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div className="mt-6 text-center text-light/50 text-sm">
            &copy; {new Date().getFullYear()} The Qube. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
